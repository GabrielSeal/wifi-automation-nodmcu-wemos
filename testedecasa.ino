...
client.println("<h1 class='text-center'>Automação da casa</h1>");
client.println("<h2 class='text-center'>Gabriel Seal</h2>");
client.println("</div>");
client.println("<div class='col-md-6'>");
client.println("<div class='alert alert-info text-center' role='alert'>Arcondicionado</div>");
client.println("<a class='btn btn-danger btn-lg center-block' href=\"/LED=OFF\"> Desligar </a>");
client.println("<br>");
client.println("<a class='btn btn-success btn-lg center-block' href=\"/LED=PLUS\"> Regular temp+</a>");
client.println("<br>");
client.println("<a class='btn btn-danger btn-lg center-block' href=\"/LED=DOWN\"> Regular temp-</a>");
client.println("<br>");
client.println("<a class='btn btn-success btn-lg center-block' href=\"/LED=ON\"> Ligar </a>");
client.println("</div>");
client.println("<div class='col-md-6'>");
client.println("<div class='alert alert-info text-center' role='alert'>Sala</div>");
